import{o as h,p as o,q as e,r as p,s as i,t as m,v as n,w as d,x as F,y as f,z as E,A as v,C as M}from"./index.de637a18.js";import{f as u,h as B,i as I,j as V}from"./index.f0f98b5f.js";import{as as t,bX as x,bY as H}from"./index.0dd4a88f.js";import{I as k}from"./Layout.ac264251.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function A(a){return t({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>`},a)}function D(a){return t({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#909090"
  ...
  ></path>F`},a)}const L={"dmg,ipa,plist,tipa":m,"exe,msi":n,"zip,gz,rar,7z,tar,jar,xz":d,apk:k,db:u,md:F,epub:B,iso:I,m3u8:i,"doc,docx":f,"xls,xlsx":E,"ppt,pptx":v,pdf:M,psd:A,ai:D,url:V},Z=(a,s)=>{if(a!==l.FOLDER){for(const[c,r]of Object.entries(L))if(c.split(",").includes(s.toLowerCase()))return r}switch(a){case l.FOLDER:return H;case l.VIDEO:return i;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},S=a=>Z(a.type,x(a.name));export{l as O,S as g};
