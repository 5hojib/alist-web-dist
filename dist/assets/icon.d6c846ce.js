import{q as h,r as o,s as e,t as p,v as i,w as m,x as n,y as d,z as F,A as f,C as E,D as v,E as M}from"./index.d97e2bda.js";import{f as u,h as B,i as I,j as V}from"./index.768fe2c8.js";import{ah as t,bX as x,bY as H}from"./index.8fe5fa95.js";import{I as k}from"./Layout.825f6114.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function D(a){return t({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}const L={"dmg,ipa,plist,tipa":m,"exe,msi":n,"zip,gz,rar,7z,tar,jar,xz":d,apk:k,db:u,md:F,epub:B,iso:I,m3u8:i,"doc,docx":f,"xls,xlsx":E,"ppt,pptx":v,pdf:M,psd:D,ai:A,url:V},Z=(a,c)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(c.toLowerCase()))return r}switch(a){case l.FOLDER:return H;case l.VIDEO:return i;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},S=a=>Z(a.type,x(a.name));export{l as O,S as g};
